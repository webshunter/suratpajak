...
// jika user sudah login
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h3 class="content-header-title"><i class="icon-file-text2"></i> Surat Masuk </h3>
        </div>
    ...
    elseif ($_GET['alert'] == 1) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            ...
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data surat masuk berhasil disimpan.
        </div>
    <?php
    } 
    // jika alert = 2
    ...
    elseif ($_GET['alert'] == 2) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            ...
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data surat masuk berhasil diubah.
        </div>
    <?php
    }
    // jika alert = 3
    ...
    elseif ($_GET['alert'] == 3) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            ...
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data surat masuk berhasil dihapus.
        </div>
    <?php
    } 
    // jika alert = 4
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            <a href="surat-masuk-add" class="btn btn-info"><i class="icon-plus"></i> Tambah </a>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tabel-surat-masuk').DataTable( {
            ...
            "processing": true,
            "serverSide": true,
            "ajax": 'modules/surat-masuk/data.php',
            "columnDefs": [ 
                ...
                { "targets": 8, "visible": false },
                {
                  ...
                  "render": function(data, type, row) {
                      var btn = "<a style=\"margin-right:5px\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Detail\" class=\"btn btn-info btn-sm\" href=\"surat-masuk-detail-"+data[ 9 ]+"\"><i class=\"icon-plus-circle\"></i></a><a data-toggle=\"tooltip\" data-placement=\"top\" title=\"Cetak Disposisi\" class=\"btn btn-warning btn-sm\" href=\"surat-masuk-disposisi-"+data[ 9 ]+"\" target=\"_balnk\"><i class=\"icon-printer3\"></i></a>";
                      return btn;
                  } 
                } 
            ],
