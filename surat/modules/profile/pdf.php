...
if (isset($_POST['cetak'])) {
                ...
                <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                    <thead style="background:#e8ecee">
                        <tr class="tr-title">
                            ...
                            <th height="25" align="center" valign="middle">NPWP</th>
                            <th height="25" align="center" valign="middle">KODE KPP / CABANG</th>
                            <th height="25" align="center" valign="middle">NAMA</th>
                            <th height="25" align="center" valign="middle">KENDALA</th>
                            <th height="25" align="center" valign="middle">SARAN</th>
                            <th height="25" align="center" valign="middle">LAIN LAIN</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php  
                    ...
                    if ($rows > 0) {
                        while ($data = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td width="115" height="17" align="center" valign="middle"><?php echo $data["npwp"]; ?></td>
                                <td width="130" height="17" align="center" valign="middle"><?php echo $data['kode_kpp']; ?> / <?php echo $data['kode_cabang']; ?></td>
                                <td style="padding-left:7px;padding-right:5px;" width="240" height="17" valign="middle"><?php echo $data['nama']; ?></td>
                                <td width="205" height="17" align="center" valign="middle"><?php echo $data["kendala"]; ?></td>
                                <td width="115" height="17" align="center" valign="middle"><?php echo $data['saran_masukan']; ?></td>
                                <td style="padding-left:7px;padding-right:5px;" width="240" height="17" valign="middle"><?php echo $data['lain_lain']; ?></td>
                            </tr>
                         <?php
                            $no++;
                        } 
    ...
    if ($tgl_awal == $tgl_akhir) { 
        ...
        $filename="Laporan Profile Tanggal ".date('d-m-Y', strtotime($_POST['tgl_awal'])).".pdf";
    } else {
        $filename="Laporan Profile Tanggal ".date('d-m-Y', strtotime($_POST['tgl_awal']))." sd ".date('d-m-Y', strtotime($_POST['tgl_akhir'])).".pdf";
    }
    //==========================================================================================================
