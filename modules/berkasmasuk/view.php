...
// jika user sudah login
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h3 class="content-header-title"><i class="icon-file-text2"></i> Berkas Masuk </h3>
        </div>
    ...
    // jika alert = 1
    // tampilkan pesan "Data berkas masuk berhasil disimpan"
    elseif ($_GET['alert'] == 1) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data berkas masuk berhasil disimpan.
        </div>
    <?php
    } 
    // jika alert = 2
    // tampilkan pesan Sukses "data berkas masuk berhasil diubah"
    elseif ($_GET['alert'] == 2) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data berkas masuk berhasil diubah.
        </div>
    <?php
    }
    // jika alert = 3
    // tampilkan pesan Sukses "data berkas masuk berhasil dihapus"
    elseif ($_GET['alert'] == 3) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data berkas masuk berhasil dihapus.
        </div>
    <?php
    } 
    // jika alert = 4
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            <a href="berkasmasuk-add" class="btn btn-info"><i class="icon-plus"></i> Tambah </a>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tabel-surat-masuk').DataTable( {
            ...
            "processing": true,
            "serverSide": true,
            "ajax": 'modules/berkasmasuk/data.php',
            "columnDefs": [ 
                ...
                {   "targets": 5, "width": '120px',
                    "render": function ( data, type, row ) {
                        return 'Jenis Dokumen : <br>'+ data +' <br><br>Tgl Dokumen : '+ row[ 6 ];
                    }
                },
                ...
                { "targets": 8, "visible": true },
                {
                  ...
                  "render": function(data, type, row) {
                      var btn = "<a style=\"margin-right:5px\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Detail\" class=\"btn btn-info btn-sm\" href=\"berkasmasuk-detail-"+data[ 1]+"\"><i class=\"icon-plus-circle\"></i></a><a data-toggle=\"tooltip\" data-placement=\"top\" title=\"Cetak Disposisi\" class=\"btn btn-warning btn-sm\" href=\"berkasmasuk-disposisi-"+data[ 1 ]+"\" target=\"_balnk\"><i class=\"icon-printer3\"></i></a>";
                      return btn;
                  } 
                } 
            ],
