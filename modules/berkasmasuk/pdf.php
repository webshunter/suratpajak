...
if (isset($_POST['cetak'])) {
                ...
                <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                    <thead style="background:#e8ecee">
                        <tr class="tr-title">
                            ...
                            <th height="25" align="center" valign="middle">TANGGAL DITERIMA</th>
                            <th height="25" align="center" valign="middle">ASAL SURAT</th>
                    ...
                    if ($rows > 0) {
                        while ($data = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td width="130" height="17" align="center" valign="middle"><?php echo date('d-m-Y', strtotime($data['tanggal_diterima'])); ?></td>
    ...
    if ($tgl_awal == $tgl_akhir) { 
        ...
        $filename="Laporan Surat Masuk Tanggal ".date('d-m-Y', strtotime($_POST['tgl_awal'])).".pdf";
    } else {
        $filename="Laporan Surat Masuk Tanggal ".date('d-m-Y', strtotime($_POST['tgl_awal']))." sd ".date('d-m-Y', strtotime($_POST['tgl_akhir'])).".pdf";
    }
    //==========================================================================================================
