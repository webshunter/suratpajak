...
$result = $mysqli->query("SELECT a.id_surat_masuk,a.nomor_agenda,a.tanggal_diterima,a.asal_surat,a.nomor_surat,a.tanggal_surat,a.sifat_surat,a.perihal,a.keterangan,b.id_instansi,b.nama_instansi
    ...
    <body style="font-size: 11pt;">
        ...
        <div id="isi">
            <table style="border-right:1px solid #000;border-left:1px solid #000;border-bottom:1px solid #000" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding-left:15px;" width="140" height="30" valign="middle">Nomor Agenda</td>
                    <td width="10" height="30" valign="middle">:</td>
                    <td style="border-right:1px solid #000;" width="170" height="30" valign="middle"><?php echo $data['nomor_agenda']; ?></td>
