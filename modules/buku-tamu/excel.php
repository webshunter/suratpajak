...
if (isset($_POST['export'])) {
	...
	if ($tgl_awal == $tgl_akhir) { 
		header("content-disposition: attachment;filename=Laporan_Buku_Tamu_Tanggal_".date('d-m-Y', strtotime($_POST['tgl_awal'])).".xls");
    } else {
		header("content-disposition: attachment;filename=Laporan_Buku_Tamu_Tanggal_".date('d-m-Y', strtotime($_POST['tgl_awal']))."_sd_".date('d-m-Y', strtotime($_POST['tgl_akhir'])).".xls");
    }
	?>
	...
	<table border='1'>
		<h3>
			<thead>
				<tr>
					...
					<td align="center" valign="top"><strong>PESAN</strong></td>
					<td align="center" valign="top"><strong>TANGGAL</strong></td>
				</tr>
			</thead>
		</h3>
        ...
        if ($rows > 0) {
	      ...
	      <td align="center" valign="top"><?php echo $no; ?></td>
                    <td align="center" valign="top" width="200"><?php echo $data['nama']; ?></td>
                    <td valign="top" width="200"><?php echo $data['email']; ?></td>
                    <td align="center" valign="top" width="500"><?php echo $data["pesan"]; ?></td>
