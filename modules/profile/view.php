...
// jika user sudah login
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h3 class="content-header-title"><i class="icon-user"></i> Profile </h3>
        </div>
    ...
    elseif ($_GET['alert'] == 1) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            ...
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data profile berhasil disimpan.
        </div>
    <?php
    } 
    // jika alert = 2
    ...
    elseif ($_GET['alert'] == 2) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            ...
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data profile berhasil diubah.
        </div>
    <?php
    }
    // jika alert = 3
    ...
    elseif ($_GET['alert'] == 3) { ?>
        <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
            ...
            <strong><i style="margin-right:7px" class="icon-checkmark2"></i>Sukses!</strong> Data profile berhasil dihapus.
        </div>
    <?php
    } 
    // jika alert = 4
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            <a href="profile-add" class="btn btn-info"><i class="icon-plus"></i> Tambah </a>
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                            <table id="tabel-profile" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No. </th>
                                        <th>NPWP</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel1"><i style="margin-right:7px" class="icon-file-text2"></i> Laporan Profile </h4>
                </div>
                <form action="laporan-profile-pdf" method="POST" target="_blank">
    ...
    <div class="modal fade text-xs-left" id="excel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="laporan-profile-excel" method="POST" target="_blank">
                    <div class="modal-body">
                        <div class="form-body">
                            <p>Tanggal</p>
                            <div class="row">
    ...
    $(document).ready(function() {
        ...
        var table = $('#tabel-profile').DataTable( {
            "bAutoWidth": false,
            "processing": true,
            "serverSide": true,
            "ajax": 'modules/profile/data.php',
            "columnDefs": [ 
                { "targets": 0, "data": null, "orderable": false, "searchable": false, "width": '30px', "className": 'center' },
                { "targets": 1, "width": '110px', "className": 'center' },
                ...
                { "targets": 6 },
                {
                  "targets": 7, "data": null, "orderable": false, "searchable": false, "width": '60px', "className": 'center',
                  "render": function(data, type, row) {
                      var btn = "<a style=\"margin-right:5px\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Detail\" class=\"btn btn-info btn-sm\" href=\"profile-detail-"+data[ 0 ]+"\"><i class=\"icon-plus-circle\"></i></a><a data-toggle=\"tooltip\" data-placement=\"top\" title=\"Cetak Disposisi\" class=\"btn btn-warning btn-sm\" href=\"profile-disposisi-"+data[ 0 ]+"\" target=\"_balnk\"><i class=\"icon-printer3\"></i></a>";
                      return btn;
                  } 
                } 
            ],
